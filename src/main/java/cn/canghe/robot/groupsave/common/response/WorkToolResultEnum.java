 ...
 * @description 返回结果 workTool
 * @menu
 */

public enum WorkToolResultEnum implements IResult {
    OK(0, "success");
//    FAIL(1000, "fail"),
...
//    SERVICE_NOT_FOUND(5004, "service_not_found");
    ...
    private WorkToolResultEnum(int code, String message) {
        this.code = code;
        this.message = message;
    }

//    public static WorkToolResultEnum getResultEnum(int code) {
//        WorkToolResultEnum[] var1 = values();
//        int var2 = var1.length;
//
//        for(int var3 = 0; var3 < var2; ++var3) {
//            WorkToolResultEnum type = var1[var3];
...
//    }
//
//    public static WorkToolResultEnum getResultEnum(String message) {
//        WorkToolResultEnum[] var1 = values();
//        int var2 = var1.length;
//
//        for(int var3 = 0; var3 < var2; ++var3) {
